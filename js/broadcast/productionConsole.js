...
} from "./dataContract.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./broadcastState.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./broadcastOutput.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./assetManager.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./fixtures/broadcastPlaygroundFixtures.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./actionEngine.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./productionVariables.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./componentRenderer.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
  COMPONENT_RENDERER_FIXTURE_TYPES,
  COMPONENT_RENDERER_OUTPUTS,
  buildComponentRendererFixture,
  getComponentRendererOutput
} from "./fixtures/componentRendererFixtures.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./templateEngine.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
  TEMPLATE_ENGINE_FIXTURES,
  TEMPLATE_ENGINE_FIXTURE_TYPES,
  buildTemplateEngineFixture
} from "../../fixtures/templateEngineFixtures.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./templateRendererIntegration.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./themeEngine.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./themeTemplateIntegration.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./previewEngine.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./outputRouting.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./programMainOutput.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./announcerMonitor.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./outputSynchronization.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "./broadcastRealtimeTransport.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
  ...
  registerLiveBinding,
  resolveLiveBindings
} from "./liveBindings.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
...
export async function connectProductionConsoleRealtime(model, runtime, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1");
