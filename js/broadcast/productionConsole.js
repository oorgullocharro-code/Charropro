...
} from "./announcerMonitor.js?v=20260808-public-snapshot-critical-recovery-001-v3";
import {
...
} from "./outputSynchronization.js?v=20260808-public-snapshot-critical-recovery-001-v3";
import {
...
export async function connectProductionConsoleRealtime(model, runtime, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260808-public-snapshot-critical-recovery-001-v3");
