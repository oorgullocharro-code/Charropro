...
} from "./announcerMonitor.js?v=20260824-fmch-team-sheet-html-print-geometry-001-v1";
import {
...
} from "./outputSynchronization.js?v=20260824-fmch-team-sheet-html-print-geometry-001-v1";
import {
...
export async function connectProductionConsoleRealtime(model, runtime, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260824-fmch-team-sheet-html-print-geometry-001-v1");
