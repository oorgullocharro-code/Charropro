...
} from "./programMainOutput.js?v=20260813-operational-flow-public-portal-corrections-001-v1";
import {
...
} from "./announcerMonitor.js?v=20260813-operational-flow-public-portal-corrections-001-v1";
import {
...
} from "./outputSynchronization.js?v=20260813-operational-flow-public-portal-corrections-001-v1";
import {
...
export async function connectProductionConsoleRealtime(model, runtime, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260813-operational-flow-public-portal-corrections-001-v1");
