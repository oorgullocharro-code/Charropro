...
} from "./outputSynchronization.js?v=20260813-scorer-workspace-viewport-compaction-001-v1";
import {
...
export async function connectProductionConsoleRealtime(model, runtime, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260813-scorer-workspace-viewport-compaction-001-v1");
