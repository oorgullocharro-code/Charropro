...
} from "./productionConsole.js?v=20260811-scorer-information-hierarchy-compaction-001-v1";
import {
...
export function createBroadcastStudioEngine(options = {}) {
  ...
  return Object.freeze({
    ...
    async connect() {
      ...
      try {
        runtime.firebaseBroadcastApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260811-scorer-information-hierarchy-compaction-001-v1");
