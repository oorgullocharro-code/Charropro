...
} from "./productionConsole.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import {
...
import { destroyTemplateRendererIntegration } from "./templateRendererIntegration.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyThemeTemplateIntegration } from "./themeTemplateIntegration.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyPreviewEngine } from "./previewEngine.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyProgramEngine } from "./programEngine.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyOutputRoutingEngine } from "./outputRouting.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyBroadcastRealtimeTransport } from "./broadcastRealtimeTransport.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { destroyLiveBindingsEngine } from "./liveBindings.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
...
export function createBroadcastStudioEngine(options = {}) {
  ...
  return Object.freeze({
    ...
    async connect() {
      ...
      try {
        runtime.firebaseBroadcastApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3");
