...
} from "./productionConsole.js?v=20260808-fmch-2026-cala-scorer-001-v1";
import {
...
export function createBroadcastStudioEngine(options = {}) {
  ...
  return Object.freeze({
    ...
    async connect() {
      ...
      try {
        runtime.firebaseBroadcastApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260808-fmch-2026-cala-scorer-001-v1");
