...
} from "./productionConsole.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import {
...
import { destroyTemplateRendererIntegration } from "./templateRendererIntegration.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyThemeTemplateIntegration } from "./themeTemplateIntegration.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyPreviewEngine } from "./previewEngine.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyProgramEngine } from "./programEngine.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyOutputRoutingEngine } from "./outputRouting.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyBroadcastRealtimeTransport } from "./broadcastRealtimeTransport.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { destroyLiveBindingsEngine } from "./liveBindings.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
...
export function createBroadcastStudioEngine(options = {}) {
  ...
  return Object.freeze({
    ...
    async connect() {
      ...
      try {
        runtime.firebaseBroadcastApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1");
