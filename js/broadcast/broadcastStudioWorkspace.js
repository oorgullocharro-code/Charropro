...
} from "./productionConsole.js?v=20260813-scorer-workspace-viewport-compaction-001-v1";
import {
...
export function createBroadcastStudioEngine(options = {}) {
  ...
  return Object.freeze({
    ...
    async connect() {
      ...
      try {
        runtime.firebaseBroadcastApi = options.firebaseApi || await import("../core/firebaseSync.js?v=20260813-scorer-workspace-viewport-compaction-001-v1");
