...
function buildProgramProjection(snapshot, options) {
  ...
  return {
    ...
    projection: {
      kind: "program-main",
      state: "program",
      projectionVersion: program.projectionVersion || null,
      programId: program.programId,
      revision: program.revision,
      sourceRevision: nonNegativeInteger(program.sourceRevision, nonNegativeInteger(snapshot.revision, 0)),
      programRevision: nonNegativeInteger(program.programRevision, program.revision),
      ...
      components: Array.isArray(program.components) ? program.components : [],
      layers: Array.isArray(program.layers) ? program.layers : [],
