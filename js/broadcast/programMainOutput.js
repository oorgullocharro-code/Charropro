...
export async function connectProgramMainRealtime(instance, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || (!options.adapter ? await import("../core/firebaseSync.js?v=20260813-scorer-operational-stabilization-checkpoint-001-v1") : null);
