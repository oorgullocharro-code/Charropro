...
} from "./browserOutput.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
import {
...
export async function connectProgramMainRealtime(instance, options = {}) {
  ...
  const transportApi = options.transportApi || await import("./broadcastRealtimeTransport.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1");
  const accessId = params.get("access") || options.accessId || null;
  const firebaseApi = options.firebaseApi || (!options.adapter ? await import("../core/firebaseSync.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1") : null);
