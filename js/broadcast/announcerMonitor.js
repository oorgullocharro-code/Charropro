...
} from "./browserOutput.js?v=20260826-fmch-2026-061-production-activation-v1";
...
export async function connectAnnouncerMonitorRealtime(instance, options = {}) {
  ...
  const transportApi = options.transportApi || await import("./broadcastRealtimeTransport.js?v=20260826-fmch-2026-061-production-activation-v1");
  const accessId = params.get("access") || options.accessId || null;
  const firebaseApi = options.firebaseApi || (!options.adapter ? await import("../core/firebaseSync.js?v=20260826-fmch-2026-061-production-activation-v1") : null);
