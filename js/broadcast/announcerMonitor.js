...
} from "./browserOutput.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
...
export async function connectAnnouncerMonitorRealtime(instance, options = {}) {
  ...
  const transportApi = options.transportApi || await import("./broadcastRealtimeTransport.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1");
  const accessId = params.get("access") || options.accessId || null;
  const firebaseApi = options.firebaseApi || (!options.adapter ? await import("../core/firebaseSync.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1") : null);
