...
export async function connectAnnouncerMonitorRealtime(instance, options = {}) {
  ...
  const firebaseApi = options.firebaseApi || (!options.adapter ? await import("../core/firebaseSync.js?v=20260811-scorer-information-hierarchy-compaction-001-v1") : null);
