...
} from "./portalRouter.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import { buildPublicPortalModel } from "./portalSelectors.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import {
  announcePublicPortalChange,
  createPublicPortalShell,
  renderPublicPortal,
  renderPublicPortalConnection
} from "./portalRender.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
