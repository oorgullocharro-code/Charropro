...
} from "./portalRouter.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { buildPublicPortalModel } from "./portalSelectors.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
  announcePublicPortalChange,
  createPublicPortalShell,
  renderPublicPortal,
  renderPublicPortalConnection
} from "./portalRender.js?v=20260912-portal-v2-home-visual-composition-002-v1";
