...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260813-scorer-workspace-viewport-compaction-001-v1";
import { getTeam, state } from "./state.js?v=20260813-scorer-workspace-viewport-compaction-001-v1";
