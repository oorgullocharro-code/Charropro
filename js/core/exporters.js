...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260820-production-release-candidate-001-v1";
import { getTeam, state } from "./state.js?v=20260820-production-release-candidate-001-v1";
