...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { getTeam, state } from "./state.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
