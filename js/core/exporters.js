...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260825-official-timer-lifecycle-sync-001-v1";
import { getTeam, state } from "./state.js?v=20260825-official-timer-lifecycle-sync-001-v1";
