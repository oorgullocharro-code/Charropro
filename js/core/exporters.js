...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import { getTeam, state } from "./state.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
