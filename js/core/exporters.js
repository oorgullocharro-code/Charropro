...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { getTeam, state } from "./state.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
