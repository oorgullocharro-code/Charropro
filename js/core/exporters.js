...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import { getTeam, state } from "./state.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
