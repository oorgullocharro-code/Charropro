...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
import { getTeam, state } from "./state.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
