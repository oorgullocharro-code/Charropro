...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
import { getTeam, state } from "./state.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
