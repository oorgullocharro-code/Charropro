...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import { getTeam, state } from "./state.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
