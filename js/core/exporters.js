...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260622-prepare-gate1";
import { getTeam, state } from "./state.js?v=20260622-prepare-gate1";
