...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260808-fmch-2026-cala-scorer-001-v1";
import { getTeam, state } from "./state.js?v=20260808-fmch-2026-cala-scorer-001-v1";
