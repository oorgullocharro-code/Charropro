...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
import { getTeam, state } from "./state.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
