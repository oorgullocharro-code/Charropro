...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { getTeam, state } from "./state.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
