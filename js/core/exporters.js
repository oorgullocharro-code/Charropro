...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { getTeam, state } from "./state.js?v=20260923-client-cache-version-recovery-fix-010-v1";
