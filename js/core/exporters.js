...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
import { getTeam, state } from "./state.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
