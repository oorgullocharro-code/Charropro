...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
import { getTeam, state } from "./state.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
