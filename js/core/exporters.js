...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import { getTeam, state } from "./state.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
