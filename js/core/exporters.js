...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260808-scoring-attempt-model-v2-001-v1";
import { getTeam, state } from "./state.js?v=20260808-scoring-attempt-model-v2-001-v1";
