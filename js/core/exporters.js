...
import { getTeamCharreadaResta, getTeamCharreadaTotal, getTeamSuerteTotal } from "./scoring.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
import { getTeam, state } from "./state.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
