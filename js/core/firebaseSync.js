...
} from "./firebaseRuntime.js?v=20260909-portal-v2-live-timeline-001-v1";
import { buildTournamentDeletionCallablePayload } from "./tournamentDeletionClient.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  COMPETITION_TYPES,
  getCompetitionType,
  getCompetitionTypeFromTournamentType
} from "../data/competitionTypes.js?v=20260909-portal-v2-live-timeline-001-v1";
import { makeAccessSession, normalizeRole, normalizeTournamentAccess } from "./roles.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  USER_ACCESS_BOOTSTRAP_ERROR,
  buildUserAccessBootstrapPlan,
  diagnoseUserAccessBootstrap,
  readUserAccessBootstrapTournaments
} from "./userAccessBootstrap.js?v=20260909-portal-v2-live-timeline-001-v1";
import { prepareHistoricalReconciliationDryRunRequest } from "./historicalReconciliationDryRun.js?v=20260909-portal-v2-live-timeline-001-v1";
import { normalizeScoringButtonLayouts } from "../data/defaultScoringButtonLayouts.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
...
} from "../broadcast/broadcastRealtimeTransport.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  buildPublicProjection,
  getPublicProjectionSignature,
  reconcilePublicProjection
} from "../public/publicProjection.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  adaptPublicProjectionToLegacyLive
} from "../public/publicProjectionLegacyAdapter.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  diagnosePublicProjectionFirebaseCompatibility,
  normalizePublicProjectionForFirebase,
  validatePublicProjection
} from "../public/publicProjectionSchema.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
...
} from "./publicProjectionOutbox.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  normalizePendingScoreReview,
  validatePendingScoreReview
} from "./pendingScoreReview.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
...
} from "./timerRules.js?v=20260909-portal-v2-live-timeline-001-v1";
import { buildOfficialCurrentTimerContext } from "./officialTimerOrchestration.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  BRAKE_REVIEW_ACTIONS,
  applyBrakeReviewCommand,
  getBrakeReviewStateFromTimer,
  isBrakeReviewProfile
} from "./brakeReviewPhase.js?v=20260909-portal-v2-live-timeline-001-v1";
