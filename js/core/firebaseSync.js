...
} from "./firebaseRuntime.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  COMPETITION_TYPES,
  getCompetitionType,
...
import { makeAccessSession, normalizeRole, normalizeTournamentAccess } from "./roles.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  USER_ACCESS_BOOTSTRAP_ERROR,
  buildUserAccessBootstrapPlan,
  diagnoseUserAccessBootstrap,
  readUserAccessBootstrapTournaments
} from "./userAccessBootstrap.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
...
} from "../broadcast/broadcastRealtimeTransport.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  buildPublicProjection,
  getPublicProjectionSignature,
  reconcilePublicProjection
} from "../public/publicProjection.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  adaptPublicProjectionToLegacyLive
} from "../public/publicProjectionLegacyAdapter.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  diagnosePublicProjectionFirebaseCompatibility,
  normalizePublicProjectionForFirebase,
  validatePublicProjection
} from "../public/publicProjectionSchema.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
...
} from "./publicProjectionOutbox.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  normalizePendingScoreReview,
  validatePendingScoreReview
} from "./pendingScoreReview.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
...
import { buildOfficialCurrentTimerContext } from "./officialTimerOrchestration.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  BRAKE_REVIEW_ACTIONS,
  applyBrakeReviewCommand,
  getBrakeReviewStateFromTimer,
  isBrakeReviewProfile
} from "./brakeReviewPhase.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
