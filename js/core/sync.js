import { SUERTES, getTournamentSuertes } from "../data/suertes.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { getCompetitionType } from "../data/competitionTypes.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildBroadcastDataContract } from "../broadcast/dataContract.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { createInitialBroadcastState } from "../broadcast/broadcastState.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { normalizeGraphicsConfig, readLocalGraphicsConfig } from "./graphicsConfig.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildOfficialPackage } from "./officialFormat.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildTournamentStandingColumns, calculateAttemptTotal } from "./scoring.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildPublicProjection } from "../public/publicProjection.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { getActiveCharreada, getActiveTournament, getCharreadaScoringEntries, getCurrentContext, getScopedLocalStorageKey, getTeam, getTournamentCharreadas, LIVE_TIMER_KEY, scoreKey, state } from "./state.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildCanonicalOfficialResults } from "./canonicalOfficialResults.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildIndividualColeaderoLiveData, isIndividualColeaderoLiveContext } from "./coleaderoLiveGraphic.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { getLiveChannelFromUrl, getTournamentLiveChannel, isFirebaseLiveConfigured, publishFirebaseLive, publishFirebaseTurn } from "./firebaseSync.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { buildOfficialTimerProjection, getTimerScopeKey, getTimerView, selectOfficialTimerForContext } from "./timerRules.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import {
  buildOfficialTimerProjectionFromCurrentContext,
  resolveOfficialCurrentTimerContext,
  resolvePreviousPialesOpportunity
} from "./officialTimerOrchestration.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import { CHARROPRO_APP_VERSION } from "./version.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
...
import { resolveCanonicalTournamentLifecycle } from "./canonicalTournamentLifecycle.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
