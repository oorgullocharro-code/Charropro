import { validateScoringAttemptV2 } from "./scoringAttempt.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
import { FMCH_2026_CALA_INFR_RULES } from "../data/calaRules.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
import {
  DOCUMENTED_CALA_BAD_POINT_CODES,
  buildCalaDocumentAbbreviationMatrix
} from "./officialFormatDocumentModel.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
