import { getTournamentSuertes, normalizeTournamentType } from "../data/suertes.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { getCompetitionType, getCompetitionTypeFromTournamentType, validateCompetitionType } from "../data/competitionTypes.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { migrateCalaAttempt, normalizeCalaRuleOverrideCatalog } from "../data/calaRules.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
...
import { normalizePendingScoreReviewRegistry } from "./pendingScoreReview.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { DEFAULT_GRAPHICS_CONFIG, normalizeGraphicsConfig } from "./graphicsConfig.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { getCanonicalTernaRoster } from "./ternaParticipantIdentity.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { getCanonicalSportingOpportunityKey } from "./canonicalOfficialResults.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import {
...
} from "./localCache.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
