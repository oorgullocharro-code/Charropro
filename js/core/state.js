import { getTournamentSuertes, normalizeTournamentType } from "../data/suertes.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { getCompetitionType, getCompetitionTypeFromTournamentType, validateCompetitionType } from "../data/competitionTypes.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { migrateCalaAttempt, normalizeCalaRuleOverrideCatalog } from "../data/calaRules.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { normalizeScoringButtonLayouts } from "../data/defaultScoringButtonLayouts.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import {
...
import { normalizePendingScoreReviewRegistry } from "./pendingScoreReview.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { DEFAULT_GRAPHICS_CONFIG, normalizeGraphicsConfig } from "./graphicsConfig.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import {
...
} from "./localCache.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
