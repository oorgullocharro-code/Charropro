import { getTournamentSuertes, normalizeTournamentType } from "../data/suertes.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { getCompetitionType, getCompetitionTypeFromTournamentType, validateCompetitionType } from "../data/competitionTypes.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { migrateCalaAttempt, normalizeCalaRuleOverrideCatalog } from "../data/calaRules.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
...
import { normalizePendingScoreReviewRegistry } from "./pendingScoreReview.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { DEFAULT_GRAPHICS_CONFIG, normalizeGraphicsConfig } from "./graphicsConfig.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { getCanonicalTernaRoster } from "./ternaParticipantIdentity.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { getCanonicalSportingOpportunityKey } from "./canonicalOfficialResults.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import {
...
} from "./localCache.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
...
export const emptyAttempt = () => ({
  ...
  remateLabel: null,
  remateMetadata: null,
  manganaScoringContractVersion: null,
  manganaRemate: null,
  manganaFaenaTimeSettlement: null,
  manganaPlacedAt: null,
  manganaDownAt: null,
  manganaManualAdditionalTotal: null,
  floreoTotal: 0,
  floreoScoredTotal: 0,
  floreoSource: null,
  floreoDetail: [],
...
export function getOrCreateOfficialTimer(timerId, definition = {}) {
  ...
  state.officialTimers[timerId] = {
    ...
    suerteLabel: definition.suerteLabel || timer.suerteLabel || "",
    phaseId: definition.phaseId || timer.phaseId || "",
    phaseLabel: definition.phaseLabel || timer.phaseLabel || "",
    teamName: definition.teamName || timer.teamName || "",
    participantName: definition.participantName || timer.participantName || "",
    attemptIndex: definition.attemptIndex ?? timer.attemptIndex ?? 0,
    opportunityIndex: definition.opportunityIndex ?? timer.opportunityIndex ?? 0,
    coleadorIndex: definition.coleadorIndex ?? timer.coleadorIndex ?? 0,
    label: definition.label || timer.label || "Cronometro oficial",
    mode: definition.mode || timer.mode || "countdown",
    timerRuleId: definition.timerRuleId || timer.timerRuleId || null,
    temporalPolicyStatus: definition.temporalPolicyStatus || timer.temporalPolicyStatus || null,
    temporalPolicyCode: definition.temporalPolicyCode || timer.temporalPolicyCode || null,
    temporalPolicyId: definition.temporalPolicyId || timer.temporalPolicyId || null,
    temporalPolicyVersion: definition.temporalPolicyVersion || timer.temporalPolicyVersion || null,
    temporalFingerprint: definition.temporalFingerprint || timer.temporalFingerprint || null
  };
