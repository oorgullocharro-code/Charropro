import { resolveRuleProfileSelection } from "../data/ruleProfiles.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import { resolveProductiveRuleProfileDefault } from "./productiveRuleProfilePolicy.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
