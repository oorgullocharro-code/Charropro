...
import {
  ...
  getTeamSuerteTotal,
  hasAttemptActivity
} from "./scoring.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
import { getTeam, scoreKey, state, uid } from "./state.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
