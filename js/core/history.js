...
import {
  ...
  getTeamSuerteTotal,
  hasAttemptActivity
} from "./scoring.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
import { getTeam, scoreKey, state, uid } from "./state.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
