...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260811-pending-review-full-scorer-integration-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260811-pending-review-full-scorer-integration-001-v1";
