...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260808-fmch-2026-piales-coleadero-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260808-fmch-2026-piales-coleadero-001-v1";
