...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260824-scorer-interaction-latency-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260824-scorer-interaction-latency-001-v1";
