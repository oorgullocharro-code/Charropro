...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260825-official-timer-live-context-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260825-official-timer-live-context-001-v1";
