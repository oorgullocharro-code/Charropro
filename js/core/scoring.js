...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
