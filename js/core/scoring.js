...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
