...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import { getTernaParticipant } from "./ternaParticipantIdentity.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import { compareOfficialRankingRows } from "./officialRanking.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
