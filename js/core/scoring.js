...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
