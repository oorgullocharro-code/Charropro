...
import { calculatePuntaBreakdown, sumTeamPenalties } from "../data/calaRules.js?v=20260911-coleadero-graphics-access-separation-and-width-fix-001-v1";
import {
  ...
  scoreKey,
  state
} from "./state.js?v=20260911-coleadero-graphics-access-separation-and-width-fix-001-v1";
...
import { compareOfficialRankingRows } from "./officialRanking.js?v=20260911-coleadero-graphics-access-separation-and-width-fix-001-v1";
