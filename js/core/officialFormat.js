import { SUERTES } from "../data/suertes.js?v=20260811-pending-review-full-scorer-integration-001-v1";
import {
...
import { getTeam, scoreKey, state } from "./state.js?v=20260811-pending-review-full-scorer-integration-001-v1";
