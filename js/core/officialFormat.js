...
} from "./officialFormatSnapshot.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import { OFFICIAL_FORMAT_DOCUMENT_ASSET_BASE64 } from "./officialFormatDocumentAssets.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import {
...
} from "./officialFormatDocumentModel.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import { state } from "./state.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import { createXlsxBlob } from "./xlsx.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
...
function aggregateRemate(attempts) {
  ...
  const labels = attempts.map(attemptRemate).filter(Boolean);
