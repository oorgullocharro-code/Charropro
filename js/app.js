import { SUERTES, TOURNAMENT_TYPES, getTournamentSuertes, getTournamentTypeConfig } from "./data/suertes.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
...
import { CHARROPRO_APP_VERSION } from "./core/version.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
import {
  ...
  sumTeamPenalties
} from "./data/calaRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
} from "./data/fmch2026PialesColeaderoRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
} from "./data/fmch2026JineteosRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
} from "./data/fmch2026TernaRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
} from "./data/fmch2026ManganasPasoRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
...
import { applyLocalFmch2026RuleProfileDefault } from "./core/localRuleProfileDefaults.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { applyProductiveRuleProfilePolicy } from "./core/productiveRuleProfilePolicy.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { EVENT_TYPES, buildEvent, registerEvent } from "./core/events.js?v=20260708-event-001b-engine-architecture1";
import { exportBackupJson, exportCurrentTournamentCsv } from "./core/exporters.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { advanceAfterCompletedTernaSession, advanceScoringPointer, previousScoringPointer, resetScoringPointer } from "./core/flow.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { downloadOfficialFormatXlsx } from "./core/officialFormat.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  ...
  getTimerScopeKey,
  getTimerView
} from "./core/timerRules.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { buildStatisticalHistorySnapshot } from "./core/history.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import { buildCharroProStatsCenter } from "./core/statistics.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  ...
  getTeamSuerteTotal,
  hasAttemptActivity
} from "./core/scoring.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  adaptLegacyAttemptToV2,
  buildOfficialScoringAttemptSnapshot
} from "./core/scoringAttempt.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  buildScorerAttemptViewModel,
  buildScorerClassificationModel,
  buildScorerRuleButtonModel
} from "./core/scorerComponents.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  createScorerSaveLatencyTrace,
  summarizeScorerSaveLatency
} from "./core/scorerSaveLatency.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
  ...
  sendToFirebaseTurn,
  sendToGoogleSheets
} from "./core/sync.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
import {
...
} from "./core/pendingScoreReview.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
...
import {
  ...
  state,
  uid
} from "./core/state.js?v=20260824-fmch-team-sheet-pre-judge-final-001-v1";
