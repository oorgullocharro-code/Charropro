import { SUERTES, TOURNAMENT_TYPES, getTournamentSuertes, getTournamentTypeConfig } from "./data/suertes.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { COMPETITION_TYPES, getCompetitionType, getCompetitionTypeFromTournamentType } from "./data/competitionTypes.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { CHARROPRO_APP_VERSION } from "./core/version.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  SCORING_BUTTON_GROUPS,
  normalizeScoringButtonGroup,
  normalizeScoringButtonLayouts
} from "./data/defaultScoringButtonLayouts.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  CALA_ADIC_SECTIONS,
  ...
  sumTeamPenalties
} from "./data/calaRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./data/fmch2026PialesColeaderoRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./data/fmch2026JineteosRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./data/fmch2026TernaRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./data/fmch2026ManganasPasoRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { closeModal, escapeHTML, html, moneylessNumber, showModal, showToast } from "./core/dom.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { applyLocalFmch2026RuleProfileDefault } from "./core/localRuleProfileDefaults.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  applyProductiveRuleProfilePolicy,
  resolveProductiveRuleProfileDefault
} from "./core/productiveRuleProfilePolicy.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { applyDefaultPublicPortalModules } from "./core/publicPortalModulePolicy.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { applyReleaseClassificationToNewTournament } from "./core/releasePolicy.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { getRuleProfile, getRuleProfileRulesByPhase } from "./data/ruleProfiles.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  SCORER_CONTEXT_STATUSES,
  isScorerContextReady,
  resolveScorerContextState
} from "./core/scorerContextResolution.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { EVENT_TYPES, buildEvent, registerEvent } from "./core/events.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { exportBackupJson, exportCurrentTournamentCsv } from "./core/exporters.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { downloadColeaderoXlsx, isColeaderoXlsxExport } from "./core/coleaderoXlsx.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { advanceAfterCompletedTernaSession, advanceScoringPointer, previousScoringPointer, resetScoringPointer } from "./core/flow.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { downloadOfficialFormatXlsx } from "./core/officialFormat.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/ternaParticipantIdentity.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  ...
  getTimerScopeKey,
  getTimerView
} from "./core/timerRules.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  deriveOfficialTimerLiveDisplay,
  officialTimerDisplayStateLabel,
  officialTimerTicker,
  updateOfficialTimerDomDisplays
} from "./core/officialTimerLiveDisplay.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  TORO_TO_TERNA_HANDOFF,
  buildOfficialCurrentTimerContext,
  buildToroToTernaReadyDefinition,
  resolveOfficialCurrentTimerContext
} from "./core/officialTimerOrchestration.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  createScorerOfficialTimerConsumer,
  subscribeScorerOfficialTimerCurrent
} from "./core/scorerOfficialTimerConsumer.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/brakeReviewPhase.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { buildStatisticalHistorySnapshot } from "./core/history.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { buildCharroProStatsCenter } from "./core/statistics.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  ...
  getTeamSuerteTotal,
  hasAttemptActivity
} from "./core/scoring.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { compareOfficialRankingRows } from "./core/officialRanking.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  getCanonicalOfficialTeamTotals,
  getCanonicalSportingOpportunityKey
} from "./core/canonicalOfficialResults.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  adaptLegacyAttemptToV2,
  buildOfficialScoringAttemptSnapshot
} from "./core/scoringAttempt.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  buildScorerAttemptViewModel,
  buildScorerClassificationModel,
  buildScorerRuleButtonModel
} from "./core/scorerComponents.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  createScorerSaveLatencyTrace,
  summarizeScorerSaveLatency
} from "./core/scorerSaveLatency.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/scorerInteractionLatency.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  ...
  sendToFirebaseTurn,
  sendToGoogleSheets
} from "./core/sync.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/firebaseSync.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  buildHistoricalReconciliationDryRunView,
  classifyHistoricalReconciliationDryRunResult
} from "./core/historicalReconciliationDryRun.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/pendingScoreReview.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { ROLES, ROLE_OPTIONS, getRoleLabel, hasTournamentAccess, isActiveAccessSession, normalizeTournamentAccess, roleCan } from "./core/roles.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  buildTournamentUrl,
...
} from "./core/tournamentContext.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  buildPortalV2PublicPath,
  buildPortalV2PublicUrl
} from "./portalV2/portalV2Router.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
...
} from "./core/supervisorNavigation.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { clearTournamentSandboxStorage } from "./core/localCache.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import {
  createRoster,
  emptyAttempt,
  ...
  state,
  uid
} from "./core/state.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
