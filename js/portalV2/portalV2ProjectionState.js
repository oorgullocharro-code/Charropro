import { applyPublicPortalSnapshot } from "../public/publicPortalClient.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import { isCanonicalPublicV3 } from "./portalV2Model.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
