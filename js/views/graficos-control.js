...
} from "../core/graphicsConfig.js?v=20260830-supervisor-tournament-deletion-nan-serialization-recovery-001-v1";
import { loadState, saveState, state } from "../core/state.js?v=20260830-supervisor-tournament-deletion-nan-serialization-recovery-001-v1";
import {
        ...
        <form id="graphics-form" class="card graphics-form">
          ...
          <div class="card-body graphics-fields">
            <div class="firebase-status">
              ...
              <span>${liveChannel ? `Los graficos toman la publicacion oficial de charropro/live/${liveChannel}/current.` : "Falta tournamentId en la URL."}</span>
            </div>
            <label>Logo
