import { escapeHTML, html, moneylessNumber } from "../core/dom.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { applyGraphicsConfig, normalizeGraphicsConfig, readLocalGraphicsConfig } from "../core/graphicsConfig.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { buildLivePayload, getCharroName } from "../core/sync.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { calculateAttemptTotal } from "../core/scoring.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { LIVE_TIMER_KEY, STORAGE_KEY, loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { getLiveChannelFromUrl, isFirebaseLiveConfigured, subscribeFirebaseLiveCurrent } from "../core/firebaseSync.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { getTimerView } from "../core/timerRules.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { buildOfficialTimerProjectionFromCurrentContext } from "../core/officialTimerOrchestration.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
...
function render() {
  ...
  if (!remotePayload && isFirebaseLiveConfigured()) {
    root.innerHTML = renderWaitingOfficialObs();
    return;
  }
...
function renderWaitingOfficialObs() {
  return html`
    <main class="obs-frame">
      <section class="obs-scoreboard">
        <div class="obs-board-content">
          <div class="obs-now">
            <div class="obs-now-text">
              <span>CharroPro</span>
              <strong>Esperando publicación oficial...</strong>
              <em>El marcador se actualiza al publicar una calificación.</em>
            </div>
          </div>
        </div>
      </section>
...
function ensureFirebaseLive() {
  ...
  firebaseUnsubscribe = subscribeFirebaseLiveCurrent(liveChannel, (response) => {
    ...
    if (hasUsefulLivePayload(nextPayload)) {
      console.info("[event-test] OBS recibio live/current", {
        tournamentId: liveChannel,
        publishedScoreId: nextPayload.published?.id || ""
      });
