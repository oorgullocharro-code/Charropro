import { escapeHTML, html } from "../core/dom.js?v=20260622-prepare-gate1";
import { LIVE_TIMER_KEY, loadState, state } from "../core/state.js?v=20260622-prepare-gate1";
import { getLiveChannelFromUrl, subscribeFirebaseLive } from "../core/firebaseSync.js?v=20260622-prepare-gate1";
