...
import { LIVE_TIMER_KEY, loadState, state } from "../core/state.js?v=20260808-fmch-2026-jineteos-dynamic-001-v1";
import { getLiveChannelFromUrl, subscribeFirebaseLive } from "../core/firebaseSync.js?v=20260808-fmch-2026-jineteos-dynamic-001-v1";
