import { getTournamentSuertes } from "../data/suertes.js?v=20260811-official-timer-authority-sync-001-v1";
import { escapeHTML, html, moneylessNumber, showToast } from "../core/dom.js?v=20260708-recovery-001b-panel-status1";
import { getCharroName } from "../core/sync.js?v=20260811-official-timer-authority-sync-001-v1";
import {
  calculateAttemptTotal,
  getTeamCharreadaTotal,
  getTeamSuerteTotal
} from "../core/scoring.js?v=20260811-official-timer-authority-sync-001-v1";
import { loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260811-official-timer-authority-sync-001-v1";
import {
