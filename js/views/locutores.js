...
import { escapeHTML, html, moneylessNumber, showToast } from "../core/dom.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import { getCharroName } from "../core/sync.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import {
...
import { loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import {
