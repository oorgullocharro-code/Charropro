...
import { escapeHTML, html, moneylessNumber, showToast } from "../core/dom.js?v=20260909-portal-v2-live-timeline-001-v1";
import { getCharroName } from "../core/sync.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
  calculateAttemptTotal,
  getTeamCharreadaTotal,
  getTeamSuerteTotal
} from "../core/scoring.js?v=20260909-portal-v2-live-timeline-001-v1";
import { loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260909-portal-v2-live-timeline-001-v1";
import {
