...
import { getCharroName } from "../core/sync.js?v=20260820-production-release-candidate-001-v1";
import {
  calculateAttemptTotal,
  getTeamCharreadaTotal,
  getTeamSuerteTotal
} from "../core/scoring.js?v=20260820-production-release-candidate-001-v1";
import { loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260820-production-release-candidate-001-v1";
import {
