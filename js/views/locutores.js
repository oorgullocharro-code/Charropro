...
import { getCharroName } from "../core/sync.js?v=20260808-fmch-2026-cala-scorer-001-v1";
import {
  calculateAttemptTotal,
  getTeamCharreadaTotal,
  getTeamSuerteTotal
} from "../core/scoring.js?v=20260808-fmch-2026-cala-scorer-001-v1";
import { loadState, state, subscribeToLiveUpdates } from "../core/state.js?v=20260808-fmch-2026-cala-scorer-001-v1";
import {
