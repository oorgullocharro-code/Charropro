import { escapeHTML, html, showToast } from "../core/dom.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import { loadState, state } from "../core/state.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import {
...
import { ROLES, getRoleLabel, hasTournamentAccess, isActiveAccessSession, roleCan } from "../core/roles.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import { getTournamentIdFromUrl } from "../core/tournamentContext.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
