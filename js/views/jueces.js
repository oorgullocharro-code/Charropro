import { escapeHTML, html, showToast } from "../core/dom.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
...
import { ROLES, getRoleLabel, hasTournamentAccess, isActiveAccessSession, roleCan } from "../core/roles.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import { getTournamentIdFromUrl } from "../core/tournamentContext.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
