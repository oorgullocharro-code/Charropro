...
export function createLocalRuntimeSeedFixture(now = "2026-08-01T00:00:00.000Z") {
  ...
  const teams = [
    ...
    { id: "demo-local-equipo-b", name: "Rancheros de Ensayo", association: "Asociacion Local B", category: "Libre", roster: { integrantes: [{ name: "Charro Dos", horseName: "Centella Local" }] } },
    { id: "demo-local-equipo-c", name: "Tradicion Ficticia", association: "Asociacion Local C", category: "Libre", roster: { integrantes: [{ name: "Charro Tres", horseName: "Lucero Local" }] } }
