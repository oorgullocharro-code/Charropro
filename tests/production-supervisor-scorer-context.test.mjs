...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1");
