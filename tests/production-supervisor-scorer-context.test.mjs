...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1");
