...
} from "../js/data/fmch2026JineteosRules.js";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules, validateRuleProfile } from "../js/data/ruleProfiles.js";
import { SUERTES, resolveTournamentRules } from "../js/data/suertes.js";
import {
...
import { emptyAttempt } from "../js/core/state.js";
