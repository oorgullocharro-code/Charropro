...
} from "../js/data/fmch2026JineteosRules.js?v=20260824-cache-buster-single-authority-001-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules, validateRuleProfile } from "../js/data/ruleProfiles.js?v=20260824-cache-buster-single-authority-001-v1";
import { SUERTES, resolveTournamentRules } from "../js/data/suertes.js?v=20260824-cache-buster-single-authority-001-v1";
import {
  adaptLegacyAttemptToV2,
  buildOfficialScoringAttemptSnapshot,
  setScoringAttemptDq
} from "../js/core/scoringAttempt.js?v=20260824-cache-buster-single-authority-001-v1";
import { calculateAttemptPointSummary, calculateAttemptTotal } from "../js/core/scoring.js?v=20260824-cache-buster-single-authority-001-v1";
import { emptyAttempt } from "../js/core/state.js?v=20260824-cache-buster-single-authority-001-v1";
