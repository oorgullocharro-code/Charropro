...
} from "../js/data/fmch2026JineteosRules.js?v=20260826-fmch-2026-061-production-activation-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules, validateRuleProfile } from "../js/data/ruleProfiles.js?v=20260826-fmch-2026-061-production-activation-v1";
import { SUERTES, resolveTournamentRules } from "../js/data/suertes.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
