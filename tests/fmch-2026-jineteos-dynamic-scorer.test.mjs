...
} from "../js/data/fmch2026JineteosRules.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules, validateRuleProfile } from "../js/data/ruleProfiles.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import { SUERTES, resolveTournamentRules } from "../js/data/suertes.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import {
