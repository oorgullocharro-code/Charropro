...
} from "../js/core/pendingScoreReview.js?v=20260826-fmch-2026-061-production-activation-v1";
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260826-fmch-2026-061-production-activation-v1";
