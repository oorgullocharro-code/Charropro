...
} from "../js/core/pendingScoreReview.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
