...
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260824-cache-buster-single-authority-001-v1";
import {
...
} from "../js/data/fmch2026TernaRules.js?v=20260824-cache-buster-single-authority-001-v1";
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260824-cache-buster-single-authority-001-v1";
