...
} from "../js/core/pendingScoreReview.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
