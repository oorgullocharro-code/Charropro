...
} from "../js/core/pendingScoreReview.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import {
...
} from "../js/data/fmch2026TernaRules.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
