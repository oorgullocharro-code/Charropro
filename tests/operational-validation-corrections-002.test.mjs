...
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
