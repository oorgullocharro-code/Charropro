...
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
