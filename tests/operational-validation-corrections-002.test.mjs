...
} from "../js/core/pendingScoreReview.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import { buildGlobalColeaderoLeader } from "../js/core/scoring.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import {
...
import { adaptLegacyAttemptToV2 } from "../js/core/scoringAttempt.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
