...
} from "../js/core/generalScoreboard.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
import { normalizeGraphicsConfig } from "../js/core/graphicsConfig.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
