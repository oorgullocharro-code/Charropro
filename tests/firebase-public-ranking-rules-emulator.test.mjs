...
import { validateCanonicalPublicTournamentData } from "../js/public/canonicalPublicTournamentData.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
