...
import { validateCanonicalPublicTournamentData } from "../js/public/canonicalPublicTournamentData.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
