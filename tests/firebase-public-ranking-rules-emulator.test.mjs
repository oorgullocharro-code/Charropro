...
import { validateCanonicalPublicTournamentData } from "../js/public/canonicalPublicTournamentData.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
