...
import { validateCanonicalPublicTournamentData } from "../js/public/canonicalPublicTournamentData.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
