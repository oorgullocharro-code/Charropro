...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260831-precommercial-tournament-delete-production-backup-validation-recovery-002-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260831-precommercial-tournament-delete-production-backup-validation-recovery-002-v1";
