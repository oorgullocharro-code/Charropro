...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
