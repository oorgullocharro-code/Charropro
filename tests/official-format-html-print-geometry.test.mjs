...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260826-fmch-2026-061-production-activation-v1";
