...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260923-client-cache-version-recovery-fix-010-v1";
