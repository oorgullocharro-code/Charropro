...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
