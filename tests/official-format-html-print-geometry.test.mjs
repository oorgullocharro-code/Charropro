...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260909-live-lifecycle-canonical-source-001-v1";
