...
import { FMCH_2026_CALA_INFR_RULES } from "../js/data/calaRules.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v2";
import {
...
} from "../js/core/officialFormatDocumentModel.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v2";
