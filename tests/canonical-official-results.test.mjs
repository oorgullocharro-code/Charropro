...
} from "../js/core/canonicalOfficialResults.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
...
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
