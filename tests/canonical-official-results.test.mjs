...
} from "../js/core/canonicalOfficialResults.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
