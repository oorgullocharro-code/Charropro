...
} from "../js/core/canonicalOfficialResults.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1";
...
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1";
