...
} from "../js/core/canonicalOfficialResults.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
...
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
