...
} from "../js/core/canonicalOfficialResults.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
