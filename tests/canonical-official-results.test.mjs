...
} from "../js/core/canonicalOfficialResults.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
