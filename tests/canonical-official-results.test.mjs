...
} from "../js/core/canonicalOfficialResults.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
...
import { adaptCanonicalPublicV3ToLegacyPresentation } from "../js/public/publicProjectionLegacyAdapter.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
