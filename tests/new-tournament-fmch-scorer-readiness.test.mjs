...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260919-scoring-infractions-panel-persistence-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260919-scoring-infractions-panel-persistence-001-v1");
