...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1");
