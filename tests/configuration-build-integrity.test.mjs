...
import { bootstrapCharroProClient, buildVersionedUrl } from "../js/core/clientBootstrap.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";

const BUILD = "20260910-public-portal-default-modules-and-tournament-creation-001-v1";
