...
import configurationEngine from "../functions/configurationEngine.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
import { loadConfigurationBootstrap } from "../js/core/configurationBootstrap.js";
import { bootstrapCharroProClient, buildVersionedUrl } from "../js/core/clientBootstrap.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
