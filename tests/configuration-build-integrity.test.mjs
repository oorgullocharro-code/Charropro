...
import { bootstrapCharroProClient, buildVersionedUrl } from "../js/core/clientBootstrap.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";

const BUILD = "20260907-canonical-official-results-public-projection-parity-001-v1";
