...
import { bootstrapCharroProClient, buildVersionedUrl } from "../js/core/clientBootstrap.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";

const BUILD = "20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
