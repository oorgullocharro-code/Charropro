import {
  ...
  renderPublicPortal
} from "../../js/publicPortal/portalRender.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import {
  buildPublicPortalModel
} from "../../js/publicPortal/portalSelectors.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
