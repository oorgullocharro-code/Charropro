...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260831-official-ranking-authority-public-parity-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260831-official-ranking-authority-public-parity-001-v1";
