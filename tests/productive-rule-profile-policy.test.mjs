...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1";
