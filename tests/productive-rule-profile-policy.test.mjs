...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
