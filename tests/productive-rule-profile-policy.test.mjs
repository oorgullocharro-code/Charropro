...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
