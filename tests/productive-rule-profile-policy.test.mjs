...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
