...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1";
...
const preserved061 = resolveRuleProfileSelection({
  id: "existing-tournament-061",
  category: "Libre",
  ruleProfileId: "FMCH_2026_LIBRE",
  ruleProfileVersion: "0.6.1",
  ruleProfileAssignment: {
    authorityVersion: "1.0.0",
    tournamentId: "existing-tournament-061",
    profileId: "FMCH_2026_LIBRE",
    version: "0.6.1",
    status: "active",
...
assert.equal(preserved061.valid, true);
assert.equal(preserved061.profile.version, "0.6.1", "existing explicit 0.6.1 assignments remain pinned");
