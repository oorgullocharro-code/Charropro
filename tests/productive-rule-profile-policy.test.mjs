...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260912-portal-v2-home-visual-composition-002-v1";
