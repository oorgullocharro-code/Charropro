...
import { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } from "../js/core/productiveRuleProfilePolicy.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
import { resolveRuleProfileSelection } from "../js/data/ruleProfiles.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
