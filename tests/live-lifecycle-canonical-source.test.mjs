...
import { resolveCanonicalTournamentLifecycle } from "../js/core/canonicalTournamentLifecycle.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
