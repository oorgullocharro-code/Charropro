...
import { resolveCanonicalTournamentLifecycle } from "../js/core/canonicalTournamentLifecycle.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import { buildCanonicalPublicProjectionV3 as buildBrowserProjection } from "../js/public/canonicalPublicProjectionV3.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import { buildCanonicalPublicProjectionV3 as buildFunctionProjection } from "../functions/reconciliationShared/public/canonicalPublicProjectionV3.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
