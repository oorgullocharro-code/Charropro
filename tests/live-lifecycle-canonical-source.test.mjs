...
import { resolveCanonicalTournamentLifecycle } from "../js/core/canonicalTournamentLifecycle.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { buildCanonicalPublicProjectionV3 as buildBrowserProjection } from "../js/public/canonicalPublicProjectionV3.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { buildCanonicalPublicProjectionV3 as buildFunctionProjection } from "../functions/reconciliationShared/public/canonicalPublicProjectionV3.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { createPortalV2Model } from "../js/portalV2/portalV2Model.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
