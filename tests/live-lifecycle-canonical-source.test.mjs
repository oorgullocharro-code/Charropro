...
import { resolveCanonicalTournamentLifecycle } from "../js/core/canonicalTournamentLifecycle.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
