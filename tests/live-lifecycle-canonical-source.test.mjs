...
import { resolveCanonicalTournamentLifecycle } from "../js/core/canonicalTournamentLifecycle.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import { buildCanonicalPublicProjectionV3 as buildBrowserProjection } from "../js/public/canonicalPublicProjectionV3.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import { buildCanonicalPublicProjectionV3 as buildFunctionProjection } from "../functions/reconciliationShared/public/canonicalPublicProjectionV3.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import { createPortalV2Model } from "../js/portalV2/portalV2Model.js?v=20260909-live-lifecycle-canonical-source-001-v1";
