...
import * as api from "../js/broadcast/outputSynchronization.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import {
  createOutputRoute,
...
} from "../js/broadcast/announcerMonitor.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
