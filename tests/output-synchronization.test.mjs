...
import * as api from "../js/broadcast/outputSynchronization.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import {
  createOutputRoute,
...
} from "../js/broadcast/announcerMonitor.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
