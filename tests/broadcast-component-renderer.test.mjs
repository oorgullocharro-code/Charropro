...
} from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
import { buildComponentInstance, createBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
