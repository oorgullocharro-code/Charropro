...
} from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
import { buildComponentInstance, createBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
