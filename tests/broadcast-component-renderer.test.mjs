...
} from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
import { buildComponentInstance, createBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
