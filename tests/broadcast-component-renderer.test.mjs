...
} from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import { buildComponentInstance, createBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
