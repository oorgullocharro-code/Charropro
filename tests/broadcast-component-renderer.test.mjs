...
} from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import { buildComponentInstance, createBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
