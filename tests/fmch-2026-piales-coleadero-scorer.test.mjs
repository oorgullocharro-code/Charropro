...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260825-user-access-bootstrap-001-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260825-user-access-bootstrap-001-v1";
...
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260825-user-access-bootstrap-001-v1";
