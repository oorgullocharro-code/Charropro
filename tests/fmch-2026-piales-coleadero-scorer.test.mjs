...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260826-fmch-2026-061-production-activation-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260826-fmch-2026-061-production-activation-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
  adaptLegacyAttemptToV2,
  buildOfficialScoringAttemptSnapshot,
  setScoringAttemptDq
} from "../js/core/scoringAttempt.js?v=20260826-fmch-2026-061-production-activation-v1";
import { calculateAttemptPointSummary, calculateAttemptTotal } from "../js/core/scoring.js?v=20260826-fmch-2026-061-production-activation-v1";
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260826-fmch-2026-061-production-activation-v1";
