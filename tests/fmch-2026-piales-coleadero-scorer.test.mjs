...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260923-client-cache-version-recovery-fix-010-v1";
...
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260923-client-cache-version-recovery-fix-010-v1";
