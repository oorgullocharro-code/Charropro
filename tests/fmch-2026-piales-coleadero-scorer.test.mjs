...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import {
...
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
