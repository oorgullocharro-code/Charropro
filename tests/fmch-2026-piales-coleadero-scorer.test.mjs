...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
...
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
