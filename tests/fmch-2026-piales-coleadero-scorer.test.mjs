...
} from "../js/data/fmch2026PialesColeaderoRules.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import { FMCH_2026_LIBRE_PROFILE, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import {
...
import { createScoreCollection, emptyAttempt } from "../js/core/state.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
