...
import { getTraditionalColeaderoOfficialAttempt, indexTraditionalColeaderoOfficialAttempts } from "../js/core/coleaderoLiveGraphic.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
