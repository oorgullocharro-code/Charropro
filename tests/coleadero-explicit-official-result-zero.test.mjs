...
import { getTraditionalColeaderoOfficialAttempt, indexTraditionalColeaderoOfficialAttempts } from "../js/core/coleaderoLiveGraphic.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1";
