...
import { getTraditionalColeaderoOfficialAttempt, indexTraditionalColeaderoOfficialAttempts } from "../js/core/coleaderoLiveGraphic.js?v=20260923-client-cache-version-recovery-fix-010-v1";
