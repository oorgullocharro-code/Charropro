...
const {
  ...
  getCurrentContext,
  state
} = await import("../js/core/state.js?v=20260912-portal-v2-home-visual-composition-002-v1");
const { advanceScoringPointer } = await import("../js/core/flow.js?v=20260912-portal-v2-home-visual-composition-002-v1");
const {
  createPendingScoreReview,
  listPendingScoreReviews,
  putPendingScoreReview
} = await import("../js/core/pendingScoreReview.js?v=20260912-portal-v2-home-visual-composition-002-v1");
