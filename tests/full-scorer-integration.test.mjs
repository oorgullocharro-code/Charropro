...
const {
  ...
  getCurrentContext,
  state
} = await import("../js/core/state.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1");
const { advanceScoringPointer } = await import("../js/core/flow.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1");
const {
  createPendingScoreReview,
  listPendingScoreReviews,
  putPendingScoreReview
} = await import("../js/core/pendingScoreReview.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1");
