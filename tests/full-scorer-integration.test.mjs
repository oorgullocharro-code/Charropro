...
const {
  ...
  getCurrentContext,
  state
} = await import("../js/core/state.js?v=20260826-fmch-2026-061-production-activation-v1");
const { advanceScoringPointer } = await import("../js/core/flow.js?v=20260826-fmch-2026-061-production-activation-v1");
const {
  createPendingScoreReview,
  listPendingScoreReviews,
  putPendingScoreReview
} = await import("../js/core/pendingScoreReview.js?v=20260826-fmch-2026-061-production-activation-v1");
