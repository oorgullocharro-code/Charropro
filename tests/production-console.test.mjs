...
} from "../js/broadcast/productionConsole.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
...
} from "../js/broadcast/broadcastRealtimeTransport.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { destroyPreviewEngine, validatePreview } from "../js/broadcast/previewEngine.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { destroyProgramEngine, validateProgram } from "../js/broadcast/programEngine.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
  destroyOutputRoutingEngine,
  listOutputRoutes,
  validateOutputRoutingSnapshot
} from "../js/broadcast/outputRouting.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
  configureOutputSynchronization,
  createOutputSynchronization,
  startOutputSynchronization,
  synchronizeProgramMain
} from "../js/broadcast/outputSynchronization.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
  buildProgramMainOutputSnapshot,
  configureProgramMainOutput,
  createProgramMainOutput,
  mountProgramMainOutput
} from "../js/broadcast/programMainOutput.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { listBroadcastThemes, resolveBroadcastTheme, validateBroadcastTheme } from "../js/broadcast/themeEngine.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { COMPONENT_RENDERER_VERSION, destroyComponentRenderer } from "../js/broadcast/componentRenderer.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { getBroadcastQueue, validateBroadcastState } from "../js/broadcast/broadcastState.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { getBroadcastOutput, validateBroadcastOutput } from "../js/broadcast/broadcastOutput.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { validateBroadcastDataContract } from "../js/broadcast/dataContract.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { listBroadcastAssets, validateBroadcastAsset } from "../js/broadcast/assetManager.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { ACTION_TYPES } from "../js/broadcast/actionEngine.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { findBroadcastComponent, listBroadcastComponents, validateBroadcastComponent } from "../js/broadcast/componentLibrary.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
...
} from "../js/broadcast/templateEngine.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
  TEMPLATE_RENDERER_INTEGRATION_VERSION,
  destroyTemplateRendererIntegration,
  validateTemplateRenderSnapshot
} from "../js/broadcast/templateRendererIntegration.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import {
  THEME_TEMPLATE_INTEGRATION_VERSION,
  destroyThemeTemplateIntegration,
  validateThemeTemplateSnapshot
} from "../js/broadcast/themeTemplateIntegration.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
...
assert.equal(PRODUCTION_CONSOLE_APP_VERSION, "20260830-precommercial-tournament-test-mode-deletion-001-v1");
