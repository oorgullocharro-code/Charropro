...
import { buildOfficialTimerDefinitionsFromContext } from "../js/core/timerRules.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import { resolveFmch2026PialesPreviousOpportunityTimerResolution } from "../js/data/fmch2026PialesColeaderoRules.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import { getOrCreateOfficialTimer, state } from "../js/core/state.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
