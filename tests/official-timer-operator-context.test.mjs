...
import { resolveFmch2026PialesPreviousOpportunityTimerResolution } from "../js/data/fmch2026PialesColeaderoRules.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
import { getOrCreateOfficialTimer, state } from "../js/core/state.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
