...
} from "../js/core/localRuleProfileDefaults.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
import {
