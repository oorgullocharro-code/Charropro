...
} from "../js/core/localRuleProfileDefaults.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import {
