...
} from "../js/core/localRuleProfileDefaults.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import {
