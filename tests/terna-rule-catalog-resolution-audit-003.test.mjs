...
} from "../js/core/localRuleProfileDefaults.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1";
import {
