...
} from "../js/core/localRuleProfileDefaults.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import {
