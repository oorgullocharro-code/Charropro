...
} from "../js/core/localRuleProfileDefaults.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import {
