...
} from "../js/core/localRuleProfileDefaults.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import {
