...
} from "../js/core/localRuleProfileDefaults.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
