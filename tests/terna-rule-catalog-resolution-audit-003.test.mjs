...
} from "../js/core/localRuleProfileDefaults.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import {
