...
} from "../js/core/localRuleProfileDefaults.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
import {
