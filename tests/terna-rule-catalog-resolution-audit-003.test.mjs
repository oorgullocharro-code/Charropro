...
} from "../js/core/localRuleProfileDefaults.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
import {
