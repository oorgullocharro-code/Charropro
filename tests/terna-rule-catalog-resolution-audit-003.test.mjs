...
} from "../js/core/localRuleProfileDefaults.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import {
