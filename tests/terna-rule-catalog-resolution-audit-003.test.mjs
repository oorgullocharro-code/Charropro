...
} from "../js/core/localRuleProfileDefaults.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import {
