...
} from "../js/core/localRuleProfileDefaults.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
