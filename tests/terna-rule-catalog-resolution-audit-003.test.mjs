...
} from "../js/core/localRuleProfileDefaults.js?v=20260825-official-timer-lifecycle-sync-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260825-official-timer-lifecycle-sync-001-v1";
import {
