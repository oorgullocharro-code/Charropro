...
} from "../js/core/localRuleProfileDefaults.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import {
