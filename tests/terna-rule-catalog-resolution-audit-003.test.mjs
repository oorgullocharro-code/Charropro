...
} from "../js/core/localRuleProfileDefaults.js?v=20260824-cache-buster-single-authority-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260824-cache-buster-single-authority-001-v1";
import {
