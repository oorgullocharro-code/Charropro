...
} from "../js/core/localRuleProfileDefaults.js?v=20260825-user-access-bootstrap-001-v1";
import {
  FMCH_2026_LIBRE_PROFILE,
  resolveRuleProfileSelection
} from "../js/data/ruleProfiles.js?v=20260825-user-access-bootstrap-001-v1";
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260825-user-access-bootstrap-001-v1";
import {
