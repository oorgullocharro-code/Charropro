...
} from "../js/core/localRuleProfileDefaults.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import {
