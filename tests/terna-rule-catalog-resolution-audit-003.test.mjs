...
} from "../js/core/localRuleProfileDefaults.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
import {
