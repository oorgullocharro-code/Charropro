...
} from "../js/core/localRuleProfileDefaults.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import {
