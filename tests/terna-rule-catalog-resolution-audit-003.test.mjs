...
} from "../js/core/localRuleProfileDefaults.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
