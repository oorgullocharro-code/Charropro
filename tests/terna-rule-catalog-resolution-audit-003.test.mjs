...
} from "../js/core/localRuleProfileDefaults.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
import {
