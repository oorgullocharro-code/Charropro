...
} from "../js/core/localRuleProfileDefaults.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
import {
