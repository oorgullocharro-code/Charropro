...
} from "../js/core/localRuleProfileDefaults.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import {
