...
} from "../js/core/localRuleProfileDefaults.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import {
