...
} from "../js/core/localRuleProfileDefaults.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
import {
...
import { resolveTournamentRules, SUERTES } from "../js/data/suertes.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
import {
