...
} from "../js/core/scorerComponents.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import {
...
const RELEASE_ID = "20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
