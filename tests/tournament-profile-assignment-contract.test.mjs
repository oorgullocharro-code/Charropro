...
installStorage();
const { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1");
const { SCORER_CONTEXT_STATUSES, resolveScorerContextState } = await import("../js/core/scorerContextResolution.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1");
const { getCharreadaScoringSuertes, getCharreadaCompetitionContext } = await import("../js/core/state.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1");
