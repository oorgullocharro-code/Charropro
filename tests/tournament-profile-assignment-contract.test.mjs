...
installStorage();
const { applyProductiveRuleProfilePolicy, resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1");
const { SCORER_CONTEXT_STATUSES, resolveScorerContextState } = await import("../js/core/scorerContextResolution.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1");
const { getCharreadaScoringSuertes, getCharreadaCompetitionContext } = await import("../js/core/state.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1");
