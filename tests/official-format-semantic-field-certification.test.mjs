...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
import { buildCanonicalTernaRoster, getTernaParticipantName } from "../js/core/ternaParticipantIdentity.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
