...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260826-fmch-2026-061-production-activation-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260826-fmch-2026-061-production-activation-v1";
