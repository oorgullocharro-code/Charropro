...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import { buildCanonicalTernaRoster, getTernaParticipantName } from "../js/core/ternaParticipantIdentity.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
