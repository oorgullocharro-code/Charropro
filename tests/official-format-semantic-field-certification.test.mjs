...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260909-portal-v2-results-standings-sheet-001-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260909-portal-v2-results-standings-sheet-001-v1";
import { buildCanonicalTernaRoster, getTernaParticipantName } from "../js/core/ternaParticipantIdentity.js?v=20260909-portal-v2-results-standings-sheet-001-v1";
