...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { buildCanonicalTernaRoster, getTernaParticipantName } from "../js/core/ternaParticipantIdentity.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
