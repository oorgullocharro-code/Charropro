...
import { applyPuntaCalculation } from "../js/core/scoring.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import {
...
import { renderOfficialFormatStandaloneHtml } from "../js/core/officialFormatHtml.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import { buildCanonicalTernaRoster, getTernaParticipantName } from "../js/core/ternaParticipantIdentity.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
