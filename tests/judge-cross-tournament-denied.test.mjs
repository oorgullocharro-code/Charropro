...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
