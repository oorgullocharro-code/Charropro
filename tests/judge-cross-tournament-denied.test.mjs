...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
