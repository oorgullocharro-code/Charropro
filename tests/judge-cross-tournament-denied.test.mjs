...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260919-scoring-infractions-panel-persistence-001-v1";
