...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
