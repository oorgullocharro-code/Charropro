...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
