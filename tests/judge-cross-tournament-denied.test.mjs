...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
