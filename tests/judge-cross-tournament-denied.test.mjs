...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260920-public-sabana-v3-canonical-parity-deploy-001-v1";
