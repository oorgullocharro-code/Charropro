...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
