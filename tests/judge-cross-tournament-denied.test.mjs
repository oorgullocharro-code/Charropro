...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
