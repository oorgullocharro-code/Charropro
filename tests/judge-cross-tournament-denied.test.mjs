...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
