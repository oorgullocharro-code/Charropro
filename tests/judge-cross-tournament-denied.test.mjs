...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
