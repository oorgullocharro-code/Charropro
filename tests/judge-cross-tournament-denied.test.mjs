...
import { buildUserAccessBootstrapPlan, readUserAccessBootstrapTournaments } from "../js/core/userAccessBootstrap.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
