...
import { applyPublicPortalSnapshot } from "../js/public/publicPortalClient.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
...
} from "../js/core/officialRanking.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
