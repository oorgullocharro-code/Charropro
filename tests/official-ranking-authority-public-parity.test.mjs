...
} from "../js/public/publicProjection.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
  validatePublicProjection,
  validatePublicProjectionForRead
} from "../js/public/publicProjectionSchema.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import { applyPublicPortalSnapshot } from "../js/public/publicPortalClient.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import { adaptPublicProjectionToLegacy } from "../js/public/publicProjectionLegacyAdapter.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
  buildPublicPortalModel,
  getPortalViewDependencies
} from "../js/publicPortal/portalSelectors.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
import {
  buildOfficialRankingItems,
  compareOfficialRankingRows
} from "../js/core/officialRanking.js?v=20260912-portal-v2-home-physical-review-corrections-004-v1";
