...
} from "../js/public/publicProjection.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import {
  validatePublicProjection,
  validatePublicProjectionForRead
} from "../js/public/publicProjectionSchema.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import { applyPublicPortalSnapshot } from "../js/public/publicPortalClient.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import { adaptPublicProjectionToLegacy } from "../js/public/publicProjectionLegacyAdapter.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import {
...
} from "../js/core/officialRanking.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
