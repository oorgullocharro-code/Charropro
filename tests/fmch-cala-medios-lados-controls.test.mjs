...
import {
  ...
  migrateCalaAttempt
} from "../js/data/calaRules.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
import {
  FMCH_2026_LIBRE_PROFILE_0_6_1,
  FMCH_2026_LIBRE_PROFILE_0_6_2,
  resolveEffectiveRules
} from "../js/data/ruleProfiles.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
...
} from "../js/core/scorerInteractionLatency.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
