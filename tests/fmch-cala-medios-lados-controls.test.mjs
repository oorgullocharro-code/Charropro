...
import {
  ...
  migrateCalaAttempt
} from "../js/data/calaRules.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
  FMCH_2026_LIBRE_PROFILE_0_6_1,
  FMCH_2026_LIBRE_PROFILE_0_6_2,
  resolveEffectiveRules
} from "../js/data/ruleProfiles.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
...
import { createOfficialFormatSnapshot } from "../js/core/officialFormatSnapshot.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
...
} from "../js/core/scorerInteractionLatency.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
