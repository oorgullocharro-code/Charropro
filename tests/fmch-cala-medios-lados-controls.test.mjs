...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
...
} from "../js/core/scorerInteractionLatency.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
