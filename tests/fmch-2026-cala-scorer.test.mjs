...
assert.equal(effectiveCala.suerte.ruleResolution.profile.profileVersion, "0.2.0");
...
assert.deepEqual(FMCH_2026_LIBRE_PROFILE.metadata.loadedSuerteIds, ["cala"]);

for (const otherSuerte of SUERTES.filter((suerte) => suerte.id !== "cala")) {
...
assert.equal(attemptV2.context.ruleProfileVersion, "0.2.0");
...
assert.equal(official.context.ruleProfileVersion, "0.2.0");
