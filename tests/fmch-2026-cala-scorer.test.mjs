...
} from "../js/data/calaRules.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
import {
...
} from "../js/core/scoring.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";

const RELEASE_ID = "20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
