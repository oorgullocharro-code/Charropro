...
assert.equal(effectiveCala.suerte.ruleResolution.profile.profileVersion, "0.5.0");
...
for (const otherSuerte of SUERTES.filter((suerte) => !["cala", "piales", "colas", "toro", "lazo", "pial_ruedo", "yegua"].includes(suerte.id))) {
