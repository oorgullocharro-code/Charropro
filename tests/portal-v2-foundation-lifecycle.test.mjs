...
import { createPortalV2Model, isCanonicalPublicV3 } from "../js/portalV2/portalV2Model.js?v=20260910-portal-v2-coleadero-sheet-opportunity-detail-001-v1";
...
import { createPublicPortalClientState, evaluatePublicPortalStale } from "../js/public/publicPortalClient.js?v=20260910-portal-v2-coleadero-sheet-opportunity-detail-001-v1";
