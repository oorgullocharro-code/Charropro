...
import { applyPortalV2Snapshot } from "../js/portalV2/portalV2ProjectionState.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { createPortalV2Model, isCanonicalPublicV3 } from "../js/portalV2/portalV2Model.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { buildPortalV2Url, parsePortalV2Route } from "../js/portalV2/portalV2Router.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { createPublicPortalClientState, evaluatePublicPortalStale } from "../js/public/publicPortalClient.js?v=20260923-client-cache-version-recovery-fix-010-v1";
