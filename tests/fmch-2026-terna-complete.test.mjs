...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
