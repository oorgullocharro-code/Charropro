...
} from "../js/data/fmch2026TernaRules.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import {
...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
