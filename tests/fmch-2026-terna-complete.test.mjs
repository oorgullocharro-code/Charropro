...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260825-user-access-bootstrap-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260825-user-access-bootstrap-001-v1";
