...
} from "../js/data/fmch2026TernaRules.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
import {
  ...
  validateRuleProfile
} from "../js/data/ruleProfiles.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
import {
...
} from "../js/core/timerRules.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260824-global-fmch-scorer-resolution-fix-001-v1";
