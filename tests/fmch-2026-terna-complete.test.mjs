...
} from "../js/data/fmch2026TernaRules.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import {
...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
