...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260909-live-lifecycle-canonical-source-001-v1";
