...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
