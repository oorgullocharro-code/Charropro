...
} from "../js/data/fmch2026TernaRules.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260912-portal-v2-home-visual-composition-002-v1";
