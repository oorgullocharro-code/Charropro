...
} from "../js/data/fmch2026TernaRules.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import {
  ...
  validateRuleProfile
} from "../js/data/ruleProfiles.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260827-pre-cala-brake-review-timer-authority-context-blocker-003-v1";
