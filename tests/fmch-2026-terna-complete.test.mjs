...
} from "../js/data/fmch2026TernaRules.js?v=20260824-scorer-interaction-latency-001-v1";
import {
...
} from "../js/core/timerRules.js?v=20260824-scorer-interaction-latency-001-v1";
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260824-scorer-interaction-latency-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260824-scorer-interaction-latency-001-v1";
