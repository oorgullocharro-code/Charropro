...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
