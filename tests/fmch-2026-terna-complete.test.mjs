...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
