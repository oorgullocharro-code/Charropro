...
import { calculateAttemptTotal } from "../js/core/scoring.js?v=20260831-official-field-timer-responsive-display-recovery-001-v1";
import { emptyAttempt, normalizeScoreCollectionForSuerte } from "../js/core/state.js?v=20260831-official-field-timer-responsive-display-recovery-001-v1";
