...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260830-precommercial-tournament-test-mode-deletion-001-v1";
...
const version = "20260830-precommercial-tournament-test-mode-deletion-001-v1";
