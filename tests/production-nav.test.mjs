...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v2";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v2";
