...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260909-portal-v2-live-timeline-001-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260909-portal-v2-live-timeline-001-v1";
