...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
...
const version = String(configuration?.values?.system?.appVersion || "");
