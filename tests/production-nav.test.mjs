...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
