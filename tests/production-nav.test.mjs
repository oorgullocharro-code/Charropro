...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260923-client-cache-version-recovery-fix-010-v1";
