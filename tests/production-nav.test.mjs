...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260826-fmch-2026-061-production-activation-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260826-fmch-2026-061-production-activation-v1";
...
const version = "20260826-fmch-2026-061-production-activation-v1";
