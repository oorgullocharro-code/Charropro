...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260912-portal-v2-home-visual-composition-002-v1";
