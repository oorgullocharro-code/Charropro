...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260828-fmch-terna-federation-format-row-ownership-001-v1";
...
const version = "20260828-fmch-terna-federation-format-row-ownership-001-v1";
