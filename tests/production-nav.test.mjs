...
import { ROLES, roleCan } from "../js/core/roles.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import { CHARROPRO_APP_VERSION } from "../js/core/version.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
