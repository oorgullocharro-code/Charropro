...
} from "../js/data/fmch2026ManganasPasoRules.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
...
import { calculateAttemptPointSummary, calculateAttemptTotal } from "../js/core/scoring.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { emptyAttempt } from "../js/core/state.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import {
  applyOfficialTimerCommand,
  createOfficialTimerContext,
  getOfficialTimerContextView,
  validateOfficialTimerContext
} from "../js/core/timerRules.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
