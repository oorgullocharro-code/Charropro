...
} from "../js/data/fmch2026ManganasPasoRules.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
import {
  ...
  validateRuleProfile
} from "../js/data/ruleProfiles.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
...
import { calculateAttemptPointSummary, calculateAttemptTotal } from "../js/core/scoring.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
import { emptyAttempt } from "../js/core/state.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
import {
  applyOfficialTimerCommand,
  createOfficialTimerContext,
  getOfficialTimerContextView,
  validateOfficialTimerContext
} from "../js/core/timerRules.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
