...
import { createPortalV2Model } from "../js/portalV2/portalV2Model.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
...
import { createPublicPortalClientState } from "../js/public/publicPortalClient.js?v=20260919-cala-medios-lados-plus-one-controls-fix-001-v1";
