...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260825-user-access-bootstrap-001-v1";
...
assert.deepEqual(
  ...
  ["20260825-user-access-bootstrap-001-v1"],
