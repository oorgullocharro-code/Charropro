...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260829-fmch-official-timer-negative-overtime-temporal-scoring-integration-001-v1";
...
assert.deepEqual(
  ...
  ["20260829-fmch-official-timer-negative-overtime-temporal-scoring-integration-001-v1"],
