...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260909-public-projection-v3-release-cache-coherence-001-v1";
...
assert.deepEqual(
  ...
  ["20260909-public-projection-v3-release-cache-coherence-001-v1"],
