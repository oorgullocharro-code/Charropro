...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
...
assert.deepEqual(
  ...
  ["20260910-public-portal-default-modules-and-tournament-creation-001-v1"],
