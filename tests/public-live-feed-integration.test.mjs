...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260831-official-ranking-authority-public-parity-001-v1";
...
assert.deepEqual(
  ...
  ["20260831-official-ranking-authority-public-parity-001-v1"],
