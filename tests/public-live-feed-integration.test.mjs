...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
...
assert.deepEqual(
  ...
  ["20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1"],
