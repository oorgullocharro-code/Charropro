...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260824-production-supervisor-scorer-context-001-v1";
...
assert.deepEqual(
  ...
  ["20260824-production-supervisor-scorer-context-001-v1"],
