...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001b-v1";
...
assert.deepEqual(
  ...
  ["20260828-fmch-terna-federation-format-official-score-recovery-001b-v1"],
