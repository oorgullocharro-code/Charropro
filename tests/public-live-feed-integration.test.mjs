...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260827-official-timer-orchestration-state-machine-failsafe-001-v1";
...
assert.deepEqual(
  ...
  ["20260827-official-timer-orchestration-state-machine-failsafe-001-v1"],
