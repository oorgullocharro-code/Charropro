...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
...
assert.deepEqual(
  ...
  ["20260827-scorer-global-timer-reactivity-recovery-001-v1"],
