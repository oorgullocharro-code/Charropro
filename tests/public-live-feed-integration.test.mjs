...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260909-live-lifecycle-canonical-source-001-v1";
...
assert.deepEqual(
  ...
  ["20260909-live-lifecycle-canonical-source-001-v1"],
