...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260907-canonical-official-results-public-projection-parity-001-v1";
...
assert.deepEqual(
  ...
  ["20260907-canonical-official-results-public-projection-parity-001-v1"],
