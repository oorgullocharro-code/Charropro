...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
...
assert.deepEqual(
  ...
  ["20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1"],
