...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
...
assert.deepEqual(
  ...
  ["20260830-supervisor-tournament-deletion-authority-recovery-001-v1"],
