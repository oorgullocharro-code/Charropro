...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
...
assert.deepEqual(
  ...
  ["20260831-firebase-functions-node22-runtime-migration-001-v1"],
