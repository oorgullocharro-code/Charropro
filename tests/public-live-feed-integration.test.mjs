...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260824-scorer-interaction-latency-001-v1";
...
assert.deepEqual(
  ...
  ["20260824-scorer-interaction-latency-001-v1"],
