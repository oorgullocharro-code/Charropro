...
import { listPublicLiveFeedEvents, validatePublicLiveFeed } from "../js/public/publicLiveFeed.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
...
assert.deepEqual(
  ...
  ["20260830-grafico-cronometro-obs-responsive-layout-001-v1"],
