...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260831-official-ranking-authority-public-parity-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260831-official-ranking-authority-public-parity-001-v1";
