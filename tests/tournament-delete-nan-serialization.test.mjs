...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1";
