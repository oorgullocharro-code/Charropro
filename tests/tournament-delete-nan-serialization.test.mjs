...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
