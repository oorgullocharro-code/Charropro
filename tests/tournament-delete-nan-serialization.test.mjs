...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260910-individual-v3-scope-horse-rules-parity-fix-001-v1";
