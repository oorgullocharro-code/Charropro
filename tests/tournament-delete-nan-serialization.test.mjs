...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260923-client-cache-version-recovery-fix-010-v1";
