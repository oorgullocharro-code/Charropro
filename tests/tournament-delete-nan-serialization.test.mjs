...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260910-public-portal-default-modules-and-tournament-creation-001-v1";
