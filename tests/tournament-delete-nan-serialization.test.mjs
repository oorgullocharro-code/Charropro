...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260910-portal-v2-coleadero-sheet-opportunity-detail-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260910-portal-v2-coleadero-sheet-opportunity-detail-001-v1";
