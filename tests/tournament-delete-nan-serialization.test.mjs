...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1";
