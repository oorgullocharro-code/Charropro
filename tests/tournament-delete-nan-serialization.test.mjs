...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
