...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
