...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
