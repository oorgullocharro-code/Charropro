...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
