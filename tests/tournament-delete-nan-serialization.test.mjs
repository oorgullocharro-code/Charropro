...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
