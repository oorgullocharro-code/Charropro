...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
