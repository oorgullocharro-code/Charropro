...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260909-portal-v2-live-timeline-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260909-portal-v2-live-timeline-001-v1";
