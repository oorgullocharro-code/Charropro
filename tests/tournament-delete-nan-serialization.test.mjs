...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
