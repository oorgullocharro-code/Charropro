...
import { buildTournamentDeletionCallablePayload } from "../js/core/tournamentDeletionClient.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
import deletionAuthority from "../functions/tournamentDeletionAuthority.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
