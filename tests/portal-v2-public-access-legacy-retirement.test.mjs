...
import {
  ...
  buildPortalV2Url
} from "../js/portalV2/portalV2Router.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
import { buildLegacyPortalV2RedirectPath } from "../js/portalV2/legacyPortalRedirect.js?v=20260912-portal-v2-home-reference-composition-live-cover-005-v1";
