...
} from "../js/core/manganasFaenaScoring.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { resolveEffectiveRules, getRuleProfile } from "../js/data/ruleProfiles.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
import { calculateAttemptTotal, calculateCollectionTotal } from "../js/core/scoring.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1";
