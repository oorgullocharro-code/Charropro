...
} from "../js/core/manganasFaenaScoring.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { resolveEffectiveRules, getRuleProfile } from "../js/data/ruleProfiles.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import { calculateAttemptTotal, calculateCollectionTotal } from "../js/core/scoring.js?v=20260923-client-cache-version-recovery-fix-010-v1";
