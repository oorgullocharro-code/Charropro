...
import {
  ...
  getTeamSuerteTotal,
  hasAttemptActivity
} from "../js/core/scoring.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
import { emptyAttempt, scoreKey, state } from "../js/core/state.js?v=20260920-sabana-phase-compact-visual-parity-deploy-001-v1";
