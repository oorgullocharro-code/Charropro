...
installStorage();
const { resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1");
