...
const { resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260912-portal-v2-home-visual-composition-002-v1");
const { getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260912-portal-v2-home-visual-composition-002-v1");
