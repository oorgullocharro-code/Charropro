...
const { resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1");
const { getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1");
