...
const { resolveProductiveRuleProfileDefault } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260911-tournament-public-branding-editorial-authority-001-v1");
const { getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260911-tournament-public-branding-editorial-authority-001-v1");
