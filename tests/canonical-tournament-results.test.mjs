...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
