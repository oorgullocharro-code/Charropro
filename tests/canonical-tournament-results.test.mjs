...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
