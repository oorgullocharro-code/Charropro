...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
