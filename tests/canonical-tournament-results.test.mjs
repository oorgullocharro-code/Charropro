...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260910-recovery-skip-redundant-pending-reset-001-v1";
