...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260923-client-cache-version-recovery-fix-010-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260923-client-cache-version-recovery-fix-010-v1";
