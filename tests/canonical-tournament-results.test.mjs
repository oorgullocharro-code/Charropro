...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260909-live-lifecycle-canonical-source-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260909-live-lifecycle-canonical-source-001-v1";
