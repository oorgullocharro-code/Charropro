...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260920-sabana-tournament-wide-deploy-001-v1";
