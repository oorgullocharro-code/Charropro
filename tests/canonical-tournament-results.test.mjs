...
import { buildCanonicalOfficialResults } from "../js/core/canonicalOfficialResults.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
...
} from "../js/core/canonicalTournamentResults.js?v=20260911-tournament-public-branding-editorial-authority-001-v1";
