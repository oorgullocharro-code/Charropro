...
assert.doesNotMatch(publicRules[".write"], /juez/, "P0-B keeps public projection publication server/operator owned");
...
assert.doesNotMatch(projectionJobRules.intent[".write"], /juez/, "P0-B keeps projection intents out of judge authority");
