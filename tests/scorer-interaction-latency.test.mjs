...
} from "../js/core/scorerInteractionLatency.js?v=20260911-coleadero-graphics-access-separation-and-width-fix-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260911-coleadero-graphics-access-separation-and-width-fix-001-v1";
