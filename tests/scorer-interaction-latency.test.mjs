...
} from "../js/core/scorerInteractionLatency.js?v=20260824-production-supervisor-scorer-context-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260824-production-supervisor-scorer-context-001-v1";
