...
} from "../js/core/scorerInteractionLatency.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
