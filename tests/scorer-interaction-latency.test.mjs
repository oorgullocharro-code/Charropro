...
} from "../js/core/scorerInteractionLatency.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
