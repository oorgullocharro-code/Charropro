...
} from "../js/core/scorerInteractionLatency.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260831-firebase-functions-node22-runtime-migration-001-v1";
