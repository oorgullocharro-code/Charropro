...
} from "../js/core/scorerInteractionLatency.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";
