...
} from "../js/core/scorerInteractionLatency.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260911-coleadero-xlsx-microsoft-excel-compatibility-fix-001-v1";
