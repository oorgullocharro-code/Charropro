...
} from "../js/core/scorerInteractionLatency.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
