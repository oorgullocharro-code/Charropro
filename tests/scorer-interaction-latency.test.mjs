...
} from "../js/core/scorerInteractionLatency.js?v=20260909-live-lifecycle-canonical-source-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260909-live-lifecycle-canonical-source-001-v1";
