...
} from "../js/core/scorerInteractionLatency.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260828-fmch-terna-participant-identity-roster-persistence-001-v1";
