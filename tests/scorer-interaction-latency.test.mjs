...
} from "../js/core/scorerInteractionLatency.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260911-graphics-access-coleadero-tournament-button-001-v1";
