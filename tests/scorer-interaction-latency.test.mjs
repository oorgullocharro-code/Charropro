...
} from "../js/core/scorerInteractionLatency.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
