...
} from "../js/core/scorerInteractionLatency.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260827-scorer-live-timer-reactivity-brake-review-batch-001-v1";
