...
} from "../js/core/scorerInteractionLatency.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
