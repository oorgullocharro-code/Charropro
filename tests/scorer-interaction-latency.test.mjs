...
} from "../js/core/scorerInteractionLatency.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1";
