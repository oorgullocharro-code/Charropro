...
} from "../js/core/scorerInteractionLatency.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
import { getCharreadaScoringSuertes } from "../js/core/state.js?v=20260909-portal-v2-navigation-program-phases-001-v1";
