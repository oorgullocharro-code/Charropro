...
} from "../js/broadcast/broadcastStudioWorkspace.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
...
assert.equal(BROADCAST_STUDIO_APP_VERSION, BUILD);
