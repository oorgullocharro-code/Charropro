...
} from "../js/broadcast/broadcastStudioWorkspace.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001b-v1";

assert.equal(BROADCAST_STUDIO_WORKSPACE_VERSION, "1.0.0");
assert.equal(BROADCAST_STUDIO_APP_VERSION, "20260828-fmch-terna-federation-format-official-score-recovery-001b-v1");
