...
} from "../js/broadcast/broadcastStudioWorkspace.js?v=20260826-pre-cala-brake-review-official-phase-002-v1";

assert.equal(BROADCAST_STUDIO_WORKSPACE_VERSION, "1.0.0");
assert.equal(BROADCAST_STUDIO_APP_VERSION, "20260826-pre-cala-brake-review-official-phase-002-v1");
