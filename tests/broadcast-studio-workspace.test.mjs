...
} from "../js/broadcast/broadcastStudioWorkspace.js?v=20260830-supervisor-tournament-deletion-authority-recovery-001-v1";

assert.equal(BROADCAST_STUDIO_WORKSPACE_VERSION, "1.0.0");
assert.equal(BROADCAST_STUDIO_APP_VERSION, "20260830-supervisor-tournament-deletion-authority-recovery-001-v1");
