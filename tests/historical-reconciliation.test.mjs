...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1';
...
import { buildPublicProjection, reconcilePublicProjection } from '../js/public/publicProjection.js?v=20260920-sabana-compact-columns-ux-deploy-001-v1';
