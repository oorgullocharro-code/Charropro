...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1';
import { createOfficialFormatSnapshot } from '../js/core/officialFormatSnapshot.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v1';
