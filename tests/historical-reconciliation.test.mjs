...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1';
import { createOfficialFormatSnapshot } from '../js/core/officialFormatSnapshot.js?v=20260911-coleadero-excel-federation-colas-layout-001-v1';
