...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260919-scoring-infractions-panel-persistence-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260919-scoring-infractions-panel-persistence-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260919-scoring-infractions-panel-persistence-001-v1';
