...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260920-coleadero-explicit-official-result-zero-fix-001-v1';
