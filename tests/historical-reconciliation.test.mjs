...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1';
