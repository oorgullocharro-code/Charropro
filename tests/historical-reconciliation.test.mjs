...
import { buildCanonicalOfficialResults, getCanonicalOfficialTeamTotals } from '../js/core/canonicalOfficialResults.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1';
import scoreAuthority from '../functions/officialScoreConcurrency.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1';
import { buildPublicPortalModel } from '../js/publicPortal/portalSelectors.js?v=20260920-general-scoreboard-active-charreada-multi-team-fix-001-v1';
