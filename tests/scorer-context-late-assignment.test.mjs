...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260920-general-scoreboard-v3-live-totals-fix-002-v1");
