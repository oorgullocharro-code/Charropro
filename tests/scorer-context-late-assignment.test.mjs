...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260829-official-timer-overtime-rtdb-rules-compatibility-001-v1");
