...
installStorage();
const { applyProductiveRuleProfilePolicy } = await import("../js/core/productiveRuleProfilePolicy.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1");
...
const { getCharreadaCompetitionContext, getCharreadaScoringSuertes } = await import("../js/core/state.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1");
