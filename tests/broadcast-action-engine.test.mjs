...
} from "../js/broadcast/actionEngine.js?v=20260831-precommercial-tournament-delete-production-backup-validation-recovery-002-v1";
import {
  createInitialBroadcastState,
  getBroadcastQueue,
  setPreviewState,
  validateBroadcastState
} from "../js/broadcast/broadcastState.js?v=20260831-precommercial-tournament-delete-production-backup-validation-recovery-002-v1";
import {
  getBroadcastOutput,
  registerBroadcastOutput,
  removeBroadcastOutput
} from "../js/broadcast/broadcastOutput.js?v=20260831-precommercial-tournament-delete-production-backup-validation-recovery-002-v1";
...
assert.equal(Object.keys(ACTION_TYPES).length, 39);
...
const variableActions = new Set([
  ACTION_TYPES.REGISTER_VARIABLE, ACTION_TYPES.SET_VARIABLE, ACTION_TYPES.RESET_VARIABLE,
  ACTION_TYPES.DISABLE_VARIABLE, ACTION_TYPES.ENABLE_VARIABLE, ACTION_TYPES.EXPIRE_VARIABLE
]);
const legacyActions = allActions.filter((type) => !variableActions.has(type));
const graphicsActions = new Set([
  ...
  ACTION_TYPES.SET_VARIABLE, ACTION_TYPES.RESET_VARIABLE
]);
const roleMatrix = {
  supervisor: new Set(allActions),
  operador: new Set([...legacyActions, ACTION_TYPES.SET_VARIABLE, ACTION_TYPES.RESET_VARIABLE, ACTION_TYPES.DISABLE_VARIABLE, ACTION_TYPES.ENABLE_VARIABLE]),
