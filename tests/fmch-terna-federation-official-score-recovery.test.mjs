...
import { renderOfficialFormatSheetHtml } from "../js/core/officialFormatHtml.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1";
import {
  buildCanonicalTernaRoster,
  getCanonicalTernaRoster,
  getTernaParticipant,
  isCanonicalTernaParticipant
} from "../js/core/ternaParticipantIdentity.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1";
import { getRuleProfile, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260910-portal-v2-standings-duplication-and-page-scroll-fix-001-v1";
