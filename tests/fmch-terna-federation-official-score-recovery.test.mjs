...
import officialScoreConcurrency from "../functions/officialScoreConcurrency.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
  adaptLegacyAttemptToV2,
  buildOfficialScoringAttemptSnapshot
} from "../js/core/scoringAttempt.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
  createOfficialFormatSnapshot,
  validateOfficialFormatSnapshot
} from "../js/core/officialFormatSnapshot.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
  buildOfficialTeamSheet,
  createOfficialFormatXlsxBlob
} from "../js/core/officialFormat.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { renderOfficialFormatSheetHtml } from "../js/core/officialFormatHtml.js?v=20260912-portal-v2-home-visual-composition-002-v1";
...
} from "../js/core/ternaParticipantIdentity.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { getRuleProfile, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260912-portal-v2-home-visual-composition-002-v1";
