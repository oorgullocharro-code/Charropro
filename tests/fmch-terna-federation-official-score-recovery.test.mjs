...
} from "../js/core/scoringAttempt.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import {
  createOfficialFormatSnapshot,
  validateOfficialFormatSnapshot
} from "../js/core/officialFormatSnapshot.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import {
  buildOfficialTeamSheet,
  createOfficialFormatXlsxBlob
} from "../js/core/officialFormat.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import { renderOfficialFormatSheetHtml } from "../js/core/officialFormatHtml.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import {
  buildCanonicalTernaRoster,
  getCanonicalTernaRoster,
  getTernaParticipant,
  isCanonicalTernaParticipant
} from "../js/core/ternaParticipantIdentity.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
import { getRuleProfile, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260920-public-sabana-phase-title-ux-deploy-001-v1";
