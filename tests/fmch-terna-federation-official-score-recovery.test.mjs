...
import { renderOfficialFormatSheetHtml } from "../js/core/officialFormatHtml.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
...
} from "../js/core/ternaParticipantIdentity.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
import { getRuleProfile, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260909-public-timeline-canonical-event-producer-001-v1";
