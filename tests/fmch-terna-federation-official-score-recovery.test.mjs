...
import officialScoreConcurrency from "../functions/officialScoreConcurrency.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import {
...
import { renderOfficialFormatSheetHtml } from "../js/core/officialFormatHtml.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { buildPublicProjection } from "../js/public/publicProjection.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import {
  buildCanonicalTernaRoster,
  getCanonicalTernaRoster,
  getTernaParticipant,
  isCanonicalTernaParticipant
} from "../js/core/ternaParticipantIdentity.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { getRuleProfile, resolveEffectiveRules } from "../js/data/ruleProfiles.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
import { SUERTES } from "../js/data/suertes.js?v=20260831-official-ranking-authority-public-parity-compatibility-001-v1";
