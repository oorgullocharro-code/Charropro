...
} from "../js/broadcast/componentRenderer.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import {
  buildComponentInstance,
  createBroadcastComponent
} from "../js/broadcast/componentLibrary.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import { createBroadcastTemplate } from "../js/broadcast/templateEngine.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
import {
...
import { buildComponentRendererFixture } from "../js/broadcast/fixtures/componentRendererFixtures.js?v=20260828-fmch-terna-federation-format-official-score-recovery-001-v1";
