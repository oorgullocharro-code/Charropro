...
import configurationEngine from "../functions/configurationEngine.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
import releasePolicy from "../functions/releasePolicy.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260909-portal-v2-foundation-and-lifecycle-001-v1";
