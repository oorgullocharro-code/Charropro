...
import releasePolicy from "../functions/releasePolicy.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260913-manganas-fmch-time-remate-practical-capture-fix-001-v3";
