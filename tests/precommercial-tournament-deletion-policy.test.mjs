...
import releasePolicy from "../functions/releasePolicy.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260910-portal-v2-public-access-and-legacy-portal-retirement-001-v1";
