...
import configurationEngine from "../functions/configurationEngine.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import releasePolicy from "../functions/releasePolicy.js?v=20260923-client-cache-version-recovery-fix-010-v1";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260923-client-cache-version-recovery-fix-010-v1";
