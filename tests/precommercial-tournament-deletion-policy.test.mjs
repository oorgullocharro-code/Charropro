...
import configurationEngine from "../functions/configurationEngine.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import releasePolicy from "../functions/releasePolicy.js?v=20260912-portal-v2-home-visual-composition-002-v1";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260912-portal-v2-home-visual-composition-002-v1";
