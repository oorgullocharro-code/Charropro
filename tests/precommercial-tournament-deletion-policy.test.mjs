...
import configurationEngine from "../functions/configurationEngine.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
import releasePolicy from "../functions/releasePolicy.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
import {
  applyReleaseClassificationToNewTournament,
  resolveClientReleaseStatus
} from "../js/core/releasePolicy.js?v=20260920-team-lineup-canonical-visual-order-001-v1";
