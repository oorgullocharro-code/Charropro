...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260910-teams-participants-horses-canonical-separation-001-v1";
