...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260830-grafico-cronometro-obs-responsive-layout-001-v1";
