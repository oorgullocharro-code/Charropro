...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260912-portal-v2-home-visual-adjustments-003-v1";
