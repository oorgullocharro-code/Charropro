...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260908-supervisor-historical-reconciliation-dryrun-ui-001-v1";
