...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260909-portal-v2-results-standings-sheet-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260909-portal-v2-results-standings-sheet-001-v1";
