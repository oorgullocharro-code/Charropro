...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260824-production-supervisor-scorer-context-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260824-production-supervisor-scorer-context-001-v1";
