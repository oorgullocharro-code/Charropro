...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260827-scorer-global-timer-reactivity-recovery-001-v1";
