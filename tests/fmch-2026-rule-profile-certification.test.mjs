...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260911-admin-page-vertical-scroll-restore-001-v1";
