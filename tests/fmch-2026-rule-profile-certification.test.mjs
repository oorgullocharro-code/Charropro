...
import { buildRuleProfileContentFingerprint } from "../js/data/ruleProfileTemporalPolicy.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
import { buildEffectiveRulesFingerprint } from "../js/core/scoringAttempt.js?v=20260911-coleadero-excel-export-valid-xlsx-and-colas-sheet-001-v1";
