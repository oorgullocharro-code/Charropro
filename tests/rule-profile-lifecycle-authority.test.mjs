...
import engine from "../functions/ruleProfileLifecycleEngine.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
import service from "../functions/ruleProfileLifecycleService.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
import { FMCH_2026_LIBRE_PROFILE } from "../js/data/ruleProfiles.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
import {
  RULE_PROFILE_TEMPORAL_STATUSES,
  RULE_PROFILE_TEMPORAL_TRANSITIONS,
  buildRuleProfileContentFingerprint
} from "../js/data/ruleProfileTemporalPolicy.js?v=20260911-coleadero-live-graphics-five-rider-window-001-v1";
